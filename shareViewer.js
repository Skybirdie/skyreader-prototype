...
window.ShareViewer = (function () {
    ...
    function updateShareBookIndicator() {
        ...
        /*
         * First allow the normal Reader UI to calculate its
         * established spread label.
         *
         * Example:
         *
         *     1 / 6
        ...
        /*
         * If ui.js has supplied a spread label, preserve it.
         * Otherwise construct a safe single-page label.
         */
        let label = "";
        ...
        /*
         * Keep the same visual information as the normal Reader:
         *
         *     spread / total
         *
         * Do not replace this with a second Share-specific
         * page counter. The title is already displayed by the
         * Share heading above the book.
         */
