...
const KEY_LENGTH = 16;
const SKYMEDIA_BASE_URL = "https://skyreader-prototype.sliburd81.workers.dev";
...
function decompressBytes(bytes) {
  ...
  if (version !== 2) {
    throw new Error(
      "Unsupported C2.2 codec version: " + version
    );
  }
